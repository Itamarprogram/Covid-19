    ...
    def home():
        ...
        if request.method == 'POST':
            ...
            if reason_test == "Exposed":
                ...
                case_5 = True
            elif reason_test == "Hotels" and status_vac == "unvaccinated" and age >= 12:
        ...
        return render_template("home.html", exposed=exposed, case_1=case_1, case_2=case_2, case_3=case_3, case_4=case_4, case_5=case_5, case_6=case_6)
